      ...
      <AppBar position="static" color="transparent" className={classes.appbar}>
        <Toolbar>
          ...
          <div className={classes.buttons}>
            ...
            >
              <MenuItem onClick={this.handleClose.bind(this, 'zh')}>CN</MenuItem>
              <MenuItem onClick={this.handleClose.bind(this, 'en')}>EN</MenuItem>
            ...
            <Link href="https://discord.gg/99RJMEU" target="_blank">Discord</Link>
